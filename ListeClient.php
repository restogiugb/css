...
<table width="106%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="60" colspan="3" nowrap="nowrap" bordercolor="#FFFFFF" bgcolor="#663300" class="logo Style1"><div align="center" class="Style2">LISTE DES  CLENTS </div></td>
	<td width="4">&nbsp;</td>
	<td width="4">&nbsp;</td>
	</tr>
	...
	<tr bgcolor="#ffffff">
	<td colspan="2" valign="top" bgcolor="#ffffcc"><div align="center"></div>
	  ...
	  <img src="image_Restaurant/IMG-20240120-WA0023.jpg" width="711" height="343" /></td>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="492">
		<tr>
		<td width="492" bgcolor="#00FFFF" class="pageHeader">&nbsp;
          <table border="1">
            <tr>
              <td><div align="center"><span class="Style5">Numero Client</span></div></td>
              <td><div align="center"><span class="Style5">Nomero Client</span></div></td>
              <td><div align="center"><span class="Style5">Prenom Client</span></div></td>
              <td><div align="center"><span class="Style5">Telephone</span></div></td>
              <td><div align="center"><span class="Style5">Email</span></div></td>
            </tr>
            <?php do { ?>
              <tr>
                <td><div align="center"><span class="Style5"><?php echo $row_Recordset1['NumClient']; ?></span></div></td>
                <td><div align="center"><span class="Style5"><?php echo $row_Recordset1['NomClient']; ?></span></div></td>
                <td><div align="center"><span class="Style5"><?php echo $row_Recordset1['PrenomClient']; ?></span></div></td>
                <td><div align="center"><span class="Style5"><?php echo $row_Recordset1['Tel']; ?></span></div></td>
                <td><div align="center"><span class="Style5"><?php echo $row_Recordset1['Email']; ?></span></div></td>
              </tr>
		...
		<a href="endex.php" class="Style6"></a></td>
		</tr>
	</table>	</td>
	<td width="4">&nbsp;</td>
	<td width="4">&nbsp;</td>
